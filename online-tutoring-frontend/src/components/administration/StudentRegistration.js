...
import {  TextInput, ComboBox } from "../ui/FormInputs";
import {
  CircularProgress,
    ...
    <InputFieldsBox>
      <Formik
        ...
        onSubmit={async (values) => {
          ...
          const subjectsSelected = values.subjects.map(
                ...
                <Item>
                  {grades && (
                    <ComboBox
                      ...
                      onChange={(value) => {
                        console.log(value);
                        props.setFieldValue("grade", value);
                      }}
                      options={grades}
                    />
                  )}
                ...
                <Item>
                  {subjects && (
                    <ComboBox
                      ...
                      multiple
                      onChange={(values) =>
                        props.setFieldValue("subjects", values)
                      }
                      options={subjects}
                    />
                  )}
